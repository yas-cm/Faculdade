# Incluir na classe anterior a divisão (__truediv__) entre números complexos. O método
# correspondente deve tratar a exceção devido à divisão por zero. Testar o programa. Lembrar
# que a divisão complexa é dada pela expressão abaixo.
